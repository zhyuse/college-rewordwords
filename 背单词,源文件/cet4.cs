...
namespace 背单词
{
    public partial class cet4 : Form
    {
        ...
        private void cet4_Load(object sender, EventArgs e)
        {
            randshow();
        }
        ...
        public void randshow()
        {
            ...
            int ran1 = ran.Next(1, 3662);
            int ran2 = ran.Next(1, 3662);
            int ran3 = ran.Next(1, 3662);
            int ran4 = ran.Next(1, 3662);
            if (ran1 == ran2 || ran1 == ran3 || ran1 == ran4)
                ran1 = ran.Next(1, 3662);
            if (ran2 == ran3 || ran2 == ran4)
                ran2 = ran.Next(1, 3662);
            if (ran3 == ran4)
                ran3 = ran.Next(1, 3662);
            correctnumber = ran.Next(1, 5);
            MySqlConnection conn = new MySqlConnection(loginpage.path);
            MySqlCommand ch1 = new MySqlCommand("select chinese from  rewords.cet4 where cet4.number=" + ran1 + "", conn);
            MySqlCommand en1 = new MySqlCommand("select word from  rewords.cet4 where cet4.number=" + ran1 + "", conn);
            MySqlCommand ch2 = new MySqlCommand("select chinese from  rewords.cet4 where cet4.number=" + ran2 + "", conn);
            MySqlCommand en2 = new MySqlCommand("select word from  rewords.cet4 where cet4.number=" + ran2 + "", conn);
            MySqlCommand ch3 = new MySqlCommand("select chinese from  rewords.cet4 where cet4.number=" + ran3 + "", conn);
            MySqlCommand en3 = new MySqlCommand("select word from  rewords.cet4 where cet4.number=" + ran3 + "", conn);
            MySqlCommand ch4 = new MySqlCommand("select chinese from  rewords.cet4 where cet4.number=" + ran4 + "", conn);
            MySqlCommand en4 = new MySqlCommand("select word from  rewords.cet4 where cet4.number=" + ran4 + "", conn);
            conn.Open();
